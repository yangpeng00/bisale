...
func NewTReformationActivityServiceProcessor(handler TReformationActivityService) *TReformationActivityServiceProcessor {
  ...
  self8 := &TReformationActivityServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self8.processorMap["InsertRelation"] = &tReformationActivityServiceProcessorInsertRelation{handler:handler}
  self8.processorMap["SelectTop10Account"] = &tReformationActivityServiceProcessorSelectTop10Account{handler:handler}
  self8.processorMap["SelectInviteeListByUserId"] = &tReformationActivityServiceProcessorSelectInviteeListByUserId{handler:handler}
  self8.processorMap["EnableParticipant"] = &tReformationActivityServiceProcessorEnableParticipant{handler:handler}
return self8
}
